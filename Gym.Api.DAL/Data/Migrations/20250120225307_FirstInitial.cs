        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DailyWork = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    AreYouSomker = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    AimOfJoin = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    AnyPains = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    AllergyOfFood = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    FoodSystem = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    NumberOfMeals = table.Column<int>(type: "int", nullable: false),
                    LastExercise = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    AnyInfection = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    AbilityOfSystemMoney = table.Column<string>(type: "nvarchar(max)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TrainersData_Packages_PackageId",
                        column: x => x.PackageId,
                        principalTable: "Packages",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TrainersData_PackageId",
                table: "TrainersData",
                column: "PackageId");
        }
